...
public class MidiSynth extends JPanel implements ControlContext {
    ...
    public void open() {
    	...
    	System.out.println("midiDevice="+midiDevice);
...
//        lsm.setSelectionInterval(0,0);
	...
	public class MidiInputReceiver implements Receiver {
	    ...
	    public MidiInputReceiver(String name) {
	        this.name = name;
	        System.out.println("midi received name="+name);
	    }
	    public void send(MidiMessage msg, long timeStamp) {
	    	byte[] tab = msg.getMessage();
	 ...
	 public void on(int num) {
          cc.channel.noteOn(num, cc.velocity);
          if (record) {
              createShortEvent(NOTEON, num);
          }
      }
      public void off(int num) {
          cc.channel.noteOff(num, cc.velocity);
          if (record) {
              createShortEvent(NOTEOFF, num);
          }
      }
